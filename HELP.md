...
* The original package name 'com.file.upload-download.file-upload-download' is invalid and this project uses 'com.file.uploaddownload.fileuploaddownload' instead.
